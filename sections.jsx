...
const PKG_COPY = {
  fr: {
    ...
    compareRows: [
      ...
      { feature: 'Récupération des no-shows',                      a: true,  b: true,  c: false },
      ...
      { feature: 'Tableau de bord ROI mensuel',                    a: true,  b: true,  c: false },
      { feature: 'Support prioritaire (< 4 h)',                    a: true,  b: true,  c: false },
      { feature: 'Audit gratuit + automatisations sur mesure',     a: true,  b: false, c: false },
  ...
  en: {
    ...
    compareRows: [
      ...
      { feature: 'Monthly ROI dashboard',                      a: true,  b: true,  c: false },
      { feature: 'Priority support (< 4 h)',                   a: true,  b: true,  c: false },
      { feature: 'Free audit + custom automations',            a: true,  b: false, c: false },
